...
gcloud run deploy "$SERVICE_NAME" \
    ...
    --set-env-vars="GOOGLE_CLOUD_PROJECT_ID=${PROJECT_ID},GOOGLE_CLOUD_LOCATION=${REGION},GOOGLE_CLOUD_MODEL_ID=gemini-2.5-pro,DEFAULT_ADMIN_EMAIL=${DEFAULT_ADMIN_EMAIL},DEFAULT_ADMIN_PASSWORD=${DEFAULT_ADMIN_PASSWORD},JWT_SECRET=${JWT_SECRET},ENCRYPTION_KEY=${ENCRYPTION_KEY}" \
    --project="$PROJECT_ID"
